// Legacy imports.gi syntax example
// This demonstrates the traditional GJS-style imports syntax
...
console.log("--- GTK4 Counter (Legacy Imports) ---");
